...
export default function Home() {
    const [menuState, setMunuState] = useState(false);

    const clickMenu = () => {
        console.log('메뉴 변경');
        setMunuState((menuState) => !menuState);
    };
    ...
    return (
                    ...
                    <div className="wrap h_wrap">
                        ...
                        <div className="gnb gnb_main">
                            <ul className="dep1">
                                ...
                                <li>
                                    <a id="btnSitemap" onClick={() => clickMenu()}>
        ...
        <div className="popup_con">
          ...
          <span className="btn_pop_close">닫기</span>
        </div>
      </div> */}
        </>
    );
