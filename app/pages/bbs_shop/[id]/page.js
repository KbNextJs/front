                            ...
                            <div class="bbs_con">
                                <div id="scbd" class="scbd co-basic">
                                    ...
                                    <div class="det">
                                        <div class="hgroup">
                                            <div class="title">
                                                <strong>{programListData[params.id].title}</strong>
                                            </div>
                                            <dl>
                                                <dt>
                                                    <span class="category">{programListData[params.id].category}</span>{' '}
                                                    <span>{programListData[params.id].date}</span>
                                                </dt>
                                                <dd>
                                                    <span>
                                                        조회수:
                                                        {programListData[params.id].viewCount}
                                                    </span>
                                                </dd>
                                            </dl>
                                        </div>
                                        ...
                                        <div id="conbody" class="conbody">
                                            <a href="javascript:popview('/img_up/shop_pds/kbgoldenlife/bbs/sub05_1/add_img/2024/9-wol-sik-dan-pyo1725841292.png')">
                                                <img
                                                    ...
                                                    border="0"
                                                    id="userImg8909811"
                                                    src={programListData[params.id].src}
                                                    style={{ maxWidth: '100%' }}
                                                    title=""
                                                />
                                            </a>{' '}
